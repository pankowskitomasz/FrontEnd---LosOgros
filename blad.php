...
<html lang="pl">
    ...
    <body class="bg-black-red">
        ...
        <section class="container-full-w text-white text-center d-flex">
            <div class="row d-flex my-auto">
                <div class="xs-col-6 float-none mx-auto">
                    <h3 class="font-f3">Błąd</h3>
                    <p class="description font-f1">
                        Podczas wysyłania wiadomości wystąpił błąd. Prosimy spróbować ponownie 
                        lub skontaktować się z nami telefonicznie.
                    </p>
                </div>
            </div>
        </section>        
